...
begin
  ...
  repeat
    ...
    begin
      inc(coelho);
      cobCoelho := cobCoelho + StrToInt(InputBox('Coelhos','Informe o nº de coelhos','Nº coelhos'));
    end
    else
    begin
      inc(rato);
      cobRato := cobRato + StrToInt(InputBox('Ratos','Informe o nº de ratos','Nº ratos'));
    end;
    inc(n);
  until (n>2);
